package cn.niudehua.efficientprogramming.easyExcel.handler;
...
public class TitleColorSheetWriteHandler implements CellWriteHandler {
    ...
    public void afterCellDispose(WriteSheetHolder writeSheetHolder, WriteTableHolder writeTableHolder, List<CellData> cellDataList, Cell cell, Head head, Integer relativeRowIndex, Boolean isHead) {
        ...
        if (0 == cell.getRowIndex()) {
            ...
            // 设置背景颜色为灰色
            headWriteCellStyle.setFillForegroundColor(IndexedColors.BRIGHT_GREEN.getIndex());
